...
const FreeChargePhoneBattery = () => {
  ...
  return (
    <>
      <h2 className='text-center font-semibold text-2xl my-10'>အရေးပေါ်ဖုန်းအားသွင်းနိုင်မည့် နေရာများ</h2>
        ...
        {regions.map((region, index) => (
          ...
          >
            ...
            {region.places.map((place, i) => (
              <div key={i} className="hover:bg-gray-50 mt-3 sm:mt-4 p-2 border border-gray-100 rounded-lg">
